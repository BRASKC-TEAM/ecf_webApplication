...
?>
    <form class="border border-1 rounded p-3" action="" method="post">
        <div class="mb-3">
            ...
            <input class="form-control" type="text" id="pseudo" name="pseudo" placeholder="Your pseudonym" value="<?= $user_post['pseudo'] ?? ""; ?>">
        </div>
        <div class="mb-3">
            <label class="form-label" for="email">Email : </label>
            <input class="form-control" type="email" id="email" name="email" placeholder="Example : test@test.com" value="<?= $user_post['email'] ?? ""; ?>">
